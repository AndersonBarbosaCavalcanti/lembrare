...
import 'arvore_escoladesativado_model.dart';
export 'arvore_escoladesativado_model.dart';

class ArvoreEscoladesativadoWidget extends StatefulWidget {
  const ArvoreEscoladesativadoWidget({
    super.key,
  ...
  @override
  State<ArvoreEscoladesativadoWidget> createState() =>
      _ArvoreEscoladesativadoWidgetState();
}

class _ArvoreEscoladesativadoWidgetState
    extends State<ArvoreEscoladesativadoWidget> {
  late ArvoreEscoladesativadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArvoreEscoladesativadoModel());
                  ...
                  children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    context.pushNamed('Escolasdesativado');
                                  },
                                ),
                                Align(
                                  alignment: AlignmentDirectional(1.0, 0.0),
                    ...
                    StreamBuilder<List<EscolaRecord>>(
                      stream: queryEscolaRecord(
                        queryBuilder: (escolaRecord) => escolaRecord.where(
                          'escolacode',
                      ...
                      builder: (context, snapshot) {
                        ...
                        final textEscolaRecord = textEscolaRecordList.isNotEmpty
                            ? textEscolaRecordList.first
                            : null;
                        return Text(
                          'Escola desativada - ${textEscolaRecord?.escolanome}',
                          style:
                            ...
                            children: [
                              ...
                              StreamBuilder<List<EscolaRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<EscolaRecord> rowEscolaRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final rowEscolaRecord =
                                      rowEscolaRecordList.isNotEmpty
                                          ? rowEscolaRecordList.first
                                          : null;
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await rowEscolaRecord!.reference
                                          ...
                                          var confirmDialogResponse =
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text(
                                                            'Você deseja excluir esta escola?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
