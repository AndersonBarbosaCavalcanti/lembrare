...
DocumentReference? get currentUserReference =>
    loggedIn ? UserBancoRecord.collection.doc(currentUser!.uid) : null;

UserBancoRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserBancoRecord.getDocument(UserBancoRecord.collection.doc(uid))
              .handleError((_) {}),
    )
