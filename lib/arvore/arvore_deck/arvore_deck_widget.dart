...
import 'arvore_deck_model.dart';
export 'arvore_deck_model.dart';

class ArvoreDeckWidget extends StatefulWidget {
  const ArvoreDeckWidget({
    super.key,
  ...
  @override
  State<ArvoreDeckWidget> createState() => _ArvoreDeckWidgetState();
}

class _ArvoreDeckWidgetState extends State<ArvoreDeckWidget> {
  late ArvoreDeckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArvoreDeckModel());
                    ...
                    StreamBuilder<List<DeckRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final textDeckRecord = textDeckRecordList.isNotEmpty
                            ...
                            : null;
                        return Text(
                          'Banco de Questões - ${textDeckRecord?.decknome}',
                          style:
                                                                                                          ...
                                                                                                          onPressed: () async {
                                                                                                            var confirmDialogResponse = await showDialog<bool>(
                                                                                                                  ...
                                                                                                                  builder: (alertDialogContext) {
                                                                                                                    return AlertDialog(
                                                                                                                      title: Text('Liberar assunto para uso?'),
                                                                                                                      content: Text('Isso bloqueará a criação de novas questões.'),
                                                                                                                      actions: [
                                                                                                                        TextButton(
                                                                                                        ...
                                                                                                        FFButtonWidget(
                                                                                                          onPressed: () async {
                                                                                                            var confirmDialogResponse = await showDialog<bool>(
                                                                                                                  ...
                                                                                                                  builder: (alertDialogContext) {
                                                                                                                    return AlertDialog(
                                                                                                                      title: Text('Você deseja retirar o assunto de uso?'),
                                                                                                                      content: Text('CANCELE caso o assunto esteja ativo no aplicativo!'),
                                                                                                                      actions: [
                                                                                                                        TextButton(
                                                                                                                          onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                                                          child: Text('Cancel'),
